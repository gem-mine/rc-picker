    ...
    <div>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
        <div style={{ margin: '0 8px' }}>
          <h3>Basic</h3>
          <Picker<Moment> hideDecade {...sharedProps} locale={zhCN} />
          <Picker<Moment> hideDecade {...sharedProps} locale={enUS} />
        </div>
        <div style={{ margin: '0 8px' }}>
          <h3>Uncontrolled</h3>
          <Picker<Moment>
        ...
        <div style={{ margin: '0 8px' }}>
          <h3>Time</h3>
          <Picker<Moment> hideDecade {...sharedProps} locale={zhCN} picker="time" />
        </div>
        <div style={{ margin: '0 8px' }}>
          <h3>Time 12</h3>
          <Picker<Moment> hideDecade {...sharedProps} locale={zhCN} picker="time" use12Hours />
        </div>
        <div style={{ margin: '0 8px' }}>
          <h3>Year</h3>
          <Picker<Moment> hideDecade {...sharedProps} locale={zhCN} picker="year" />
        </div>
        <div style={{ margin: '0 8px' }}>
          <h3>Keyboard navigation (Tab key) disabled</h3>
          <Picker<Moment> hideDecade {...sharedProps} locale={enUS} tabIndex={-1} />
        </div>
      </div>
    </div>
  );
